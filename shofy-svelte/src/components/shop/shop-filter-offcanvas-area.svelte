<script lang="ts">
	...
	import OffcanvasSidebar from '../offcanvas/offcanvas-sidebar.svelte';

	let activeTab = writable('grid');
	let openOffcanvas = $state(false);
							...
							<div class="col-xl-6">
								<div class="tp-shop-top-right d-sm-flex align-items-center justify-content-xl-end">
									...
									<div class="tp-shop-top-filter">
										<button onclick={handleOpenOffcanvas} type="button" class="tp-filter-btn filter-open-dropdown-btn">
											<span>
												<Filter />
											</span>
											Filter
...
<!-- offcanvas sidebar -->
<OffcanvasSidebar {handleOpenOffcanvas} {openOffcanvas} />
<!-- offcanvas sidebar -->
