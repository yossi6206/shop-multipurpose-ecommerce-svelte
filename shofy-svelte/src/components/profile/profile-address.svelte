    ...
    <div class="col-md-6">
        <div class="profile__address-item d-sm-flex align-items-start">
          ...
          <div class="profile__address-content">
              <h3 class="profile__address-title">כתובת לחיוב</h3>
              <p><span>רחוב:</span>3576 Glen Street</p>
              <p><span>עיר:</span>Summer Shade</p>
              <p><span>מדינה/מחוז/אזור:</span>Kentucky</p>
              <p><span>מספר טלפון:</span>270-428-8378</p>
              <p><span>מיקוד:</span>42166</p>
              <p><span>קידומת מדינה:</span> +1</p>
              <p><span>מדינה:</span>United States</p>
          </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="profile__address-item d-sm-flex align-items-start">
          ...
          <div class="profile__address-content">
              <h3 class="profile__address-title">כתובת למשלוח</h3>
              <p><span>רחוב:</span>3133 Lewis Street</p>
              <p><span>עיר:</span>Naperville</p>
              <p><span>מדינה/מחוז/אזור:</span>Illinois</p>
              <p><span>מספר טלפון:</span>630-857-9127</p>
              <p><span>מיקוד:</span> 60563</p>
              <p><span>קידומת מדינה:</span>+1</p>
              <p><span>מדינה:</span>United States</p>
          </div>
        </div>
