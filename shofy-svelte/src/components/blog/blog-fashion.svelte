<script lang="ts">
	...
	const blog_items = blogData.filter((b) => b.blog === 'fashion');
</script>
...
<section class="tp-blog-area pt-110 pb-120">
	<div class="container">
		...
		<div class="row">
			{#each blog_items as item (item.id)}
		...
		<div class="row">
			<div class="col-xl-12">
				<div class="tp-blog-more-2 mt-10 text-center">
					<a href="/blog" class="tp-btn tp-btn-border tp-btn-border-sm"> Discover More </a>
				</div>
			</div>
		</div>
	</div>
